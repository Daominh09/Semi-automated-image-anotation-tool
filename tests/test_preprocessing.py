...
def test_edge_detection(test_image_path: str = None):
    ...
    os.makedirs(os.path.join(PROJECT_ROOT, 'test_images', 'test_edge_detection'), exist_ok=True)
    cv2.imwrite(os.path.join(PROJECT_ROOT, 'test_images', 'test_edge_detection', 'test_edges.png'), combined)
    cv2.imwrite(os.path.join(PROJECT_ROOT, 'test_images', 'test_edge_detection', 'og_test_edges.png'), test_image)
...
if __name__ == '__main__':
    test_edge_detection(test_image_path="test_images/image_1.png")